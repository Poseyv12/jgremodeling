              ...
              <div className="space-y-8">
                ...
                <div className="mt-8 pt-8 border-t border-border/50">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://www.facebook.com/" className="bg-black/10 p-3 rounded-xl hover:bg-black/20 transition-colors">
                    ...
                    <a href="https://www.instagram.com/ultimatekitchenbath/" className="bg-black/10 p-3 rounded-xl hover:bg-black/20 transition-colors">
                      <svg className="h-6 w-6 text-black" fill="currentColor" viewBox="0 0 24 24">
