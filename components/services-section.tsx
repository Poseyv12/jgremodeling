  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 md:px-8">
        <h2 className="text-3xl font-bold text-blue-900 text-center mb-12">Our Services</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold text-blue-800 mb-4">Remodeling</h3>
          ...
          <div>
            <h3 className="text-xl font-bold text-blue-800 mb-4">Design & Build</h3>
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                <ArrowRight className="h-4 w-4 text-blue-600 flex-shrink-0" />
          ...
          <div>
            <h3 className="text-xl font-bold text-blue-800 mb-4">Specialty Services</h3>
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                <ArrowRight className="h-4 w-4 text-blue-600 flex-shrink-0" />
